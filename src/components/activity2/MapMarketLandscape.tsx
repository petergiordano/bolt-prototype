    ...
    <div className="space-y-6">
      ...
      <div className="border-2 rounded-lg p-5 mb-4" style={{
        ...
        <div className="flex items-center mb-3">
          <Target className="mr-2" size={24} style={{ color: '#FF9000' }} />
          <h4 className="text-lg font-semibold" style={{ color: '#FF9000' }}>Market Mapping Instructions</h4>
        </div>
        <p className="mb-2" style={{ color: '#A58E6F' }}>Click on the grid to place markers:</p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            ...
            <span className="text-sm" style={{ color: competitorMarkers.length >= 1 ? '#22C55E' : '#8A8A8A' }}>
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm" style={{ color: underservedMarkers.length >= 1 ? '#22C55E' : '#8A8A8A' }}>
